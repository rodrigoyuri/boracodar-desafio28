      ...
      <div className="flex flex-col items-center justify-center gap-10 w-[76rem] p-14 rounded-[2rem] border-2 border-slate-700 bg-slate-950 opacity-80">
        <div className="flex flex-col items-center gap-10">
          ...
          <div className="flex flex-col items-start gap-4 w-[38rem]">
            <Button text="Gerador de códigos" icon={Code2} />
            <Button text="Edição de foto" icon={Image} />
            <Button text="Geração de vídeos" icon={PlayCircle} />
            <Button text="Criador de áudios e musicas" icon={Music} />
          </div>
        </div>
        ...
        <div className="flex items-start self-stretch">
          <div className="flex items-center p-4 gap-4 flex-[1_0_0]">
            <PlusCircle className="w-8 h-8 text-slate-400 flex items-center pl-2 absolute" />

            <input type="text" className="flex items-center flex-[1_0_0] gap-4 p-4 rounded-2xl border-2 border-slate-800 bg-slate-900 placeholder:pl-6 placeholder:text-slate-200" placeholder="Envie uma mensagem ou digite “/” para exibir os comandos" />

            <button className="flex items-start p-4 gap-2 rounded-2xl border border-slate-700 bg-slate-900">
